...
for (outcome in 1:6) {
  ...
  boosting_model <- xgboost(data = X_train_d[valid_customers, -1], label = Y_train[valid_customers, outcome + 1], nrounds=30, trControl=xgb_control,lambda=0, method="xgbTree")
